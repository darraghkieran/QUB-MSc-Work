...
public class Thread30Test {
	...
	public static void main(String[] args) {
		...
		Thread30 t30 = new Thread30();
		Thread thread = new Thread(t30);
		thread.start();
		...
		if (thread.isAlive()) {
			...
			if (t30.getCurrentCount() < gameLength) {
				System.out.println("Too early : that was " + t30.getCurrentCount() + " secs");
			} else if (t30.getCurrentCount() > gameLength) {
				System.out.println("Too late : that was " + t30.getCurrentCount() + " secs");
			} else {
